const CACHE='z8-safari-pwa-v5';
const CORE=['./','./index.html','./manifest.webmanifest','./icon.svg','./assets/exposure-triangle-purple.png','./assets/photography-cheat-sheet.jpeg','./assets/exposure-triangle-green.png'];
